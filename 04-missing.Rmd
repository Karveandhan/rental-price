...
The number of missing values in our dataset are significantly very less. Most of the missing values belong to the initial month (January 2014). While there are relatively fewer missing values in few other month. The significance of these missing value of the project will be less as there are sufficient datas available to carry out the project. There is only one data missing in the previous month (October 2021). So, with this available dataset project can be proceeded.

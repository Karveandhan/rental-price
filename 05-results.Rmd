...
When we compare the prices of New York apartment in 2018 and 2019, it is very clear that there has never been a fall in price for the same month in the consecutive year before the pandemic. And it is the pandemic that has caused the rental prices at New York to fall down during the year 2020. Also, the peak time during which the rental prices hike up is predominant during July (Fall) and the prices decrease when it reaches winter (December).